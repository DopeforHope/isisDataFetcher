...
###writes courses with links to an file
dataFetcher = isisDataFetcher()
CoursesAndWLinks = dataFetcher.getCourseAndLinks()
file=open("Logs/Class_Links","w")
file.write(np.array_str(CoursesAndWLinks))
###TODO:test if zip get fetched with PPR
